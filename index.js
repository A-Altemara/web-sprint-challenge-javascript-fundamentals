...
*/
CuboidMaker.prototype.volume = function(props) {
...
*/
CuboidMaker.prototype.surfaceArea = function(props) {
  let surfAre = 2 *((this.length * this.width) + (this.length * this.height) + (this.width * this.height))
  return surfAre
}
